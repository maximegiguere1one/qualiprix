  ...
  return <div className="min-h-screen bg-background">
      ...
      <section ref={heroRef} className="py-20 bg-gradient-to-br from-secondary via-secondary to-primary text-white">
        <div className="container px-4 mx-auto text-center">
          <div className={`inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 px-4 py-2 rounded-full mb-6 transition-all duration-1000 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <MapPin className="w-5 h-5" />
            <span className="font-semibold">Montréal & environs</span>
          </div>
          <h1 className={`text-4xl md:text-5xl font-bold mb-6 transition-all duration-1000 delay-100 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <Button size="lg" className={`h-14 px-8 text-lg bg-white text-white hover:bg-white/90 transition-all duration-1000 delay-300 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} onClick={() => window.location.href = 'tel:5813973587'}>
      ...
      <section className="py-16 bg-background">
        <div className="container px-4 mx-auto max-w-6xl">
          {/* Intro */}
          <div ref={introRef} className={`mb-16 transition-all duration-1000 ${introVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div ref={neighborhoodRef} className="mb-16">
            <h2 className={`text-3xl font-bold mb-8 text-center transition-all duration-1000 ${neighborhoodVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>Quartiers desservis à Montréal</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {neighborhoods.map((neighborhood, index) => <Card key={index} className={`text-center p-4 hover:shadow-[var(--shadow-elegant)] transition-all duration-800 ${neighborhoodVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => <Card key={index} className="bg-primary/5">
                  <CardHeader>
